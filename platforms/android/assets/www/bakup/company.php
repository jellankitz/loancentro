...
<form name="apply_form" id="apply_form">
    ...
    <div class="wrapper dark">
    	<div class="center">
            <h2>Practical Business Funding Solutions</h2>
            <p>
                Get Business Cash, is a leader in business financing to the small and medium size business community. We understand 
				that each business has unique challenges, demands and expectations, which is why we offer creative financing options to help meet ongoing 
				cash flow needs. 
            </p>
            <p>
                We make financing simple and payback flexible. Our accelerated application and approval process focuses on a business's future success. 
            </p>
            <p>
                Our goal is to support small businesses across North America by providing the highest level of service and support.  
            </p>
            <p><a href="http://getbusinesscash.com/apply_now.html">Click here</a> to apply now.
			</p>
			<p>
				To contact us for any other reason call us toll free at 1-888-364-2070 or email us: info@merchantcapitalfunding.com </p>
            <p></p>
        </div><!-- END -- center -->
