...
<form name="apply_form" id="apply_form">
    ...
    <div class="wrapper dark">
    	<div class="center" id="faqs">
            <h2>Do I qualify?</h2>
            <p>If you're an established business earning at least $3,000 a month in credit card receivables, you are encouraged to apply.
            </p>  
            
            <h2>What if I have bad credit?</h2>
            <p>Approval for financing is based on future sales, not credit scores. Business owners with poor credit are encouraged to apply.
            </p> 
            
            <h2>How easy is it to get approved?</h2>
            <p>Our approval rate is greater than 95%. To get started complete the three-step online application. 
            </p> 
            
            <h2>How long does it take to get approved?</h2>
            <p>You may be approved in 24 hours. 
            </p> 
            
            <h2>How soon can I receive my money?</h2>
            <p>After being approved you can receive funds in 10 days or less, directly to your account. 
            </p> 
            
            <h2>What are the payment terms?</h2>
            <p>Payback is automated and based on future sales. If business is slow, payments are less.
            </p> 
            
            <h2>Are there any hidden fees?</h2>
            <p>There are no hidden fees.
            </p> 
            
            <h2>How do I apply?</h2> 
            <p><a href="apply_now.php">Apply online</a> or call one of our financing experts toll free at 1-888-364-2070.
            </p>                             
        </div>
